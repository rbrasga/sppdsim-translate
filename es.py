...
WORDS['''
	...
	''']={5:'''Compare 1 o más tarjetas.

* Todos los datos se actualizan con frecuencia.'''}
WORDS["Select Cards"]={5:"Seleccionar tarjetas"}
WORDS["ARROWSTORM CASTER"]={5:"RUEDA ARROWSTORM"}
WORDS["LIGHTNING BOLT CASTER"]={5:"RUEDA TORNILLO RAYO"}
WORDS["TANK KID"]={5:"NIÑO TANQUE"}
WORDS["INDIAN WARRIOR"]={5:"GUERRERO INDIO"}
WORDS["INDIAN HUNTER"]={5:"CAZADOR INDIO"}
WORDS["ROYAL ARCHER"]={5:"ARQUERO REAL"}
WORDS["ARROW TOWER"]={5:"TORRE ARROW"}
WORDS["INDIAN BRUTE"]={5:"BRUTO INDIO"}
WORDS["SPACE ASSASSIN"]={5:"ASESINO ESPACIAL"}
WORDS["SPACE GRUNT"]={5:"GRAN ESPACIO"}
WORDS["SPACE GUNNER"]={5:"ARTILLERO ESPACIAL"}
WORDS["TOXIC PYLON"]={5:"PILÓN TÓXICO"}
WORDS["TURBO SPACE GRUNT"]={5:"GRUNT DEL ESPACIO TURBO"}
WORDS["CYBORG TOWER"]={5:"TORRE CYBORG"}
WORDS["SUBZERO TITAN"]={5:"SUBZERO TITAN"}
WORDS["CYBORG TITAN"]={5:"CYBORG TITAN"}
WORDS["HEALING FOUNTAIN"]={5:"FUENTE SANADORA"}
WORDS["HOLY DEFENDER TOWER"]={5:"TORRE DEL SANTO DEFENSOR"}
WORDS["ZIONIST RANGER"]={5:"GUARDABOSQUES SIONISTA"}
WORDS["MORMON MISSIONARY"]={5:"MISIONERO MORMÓN"}
WORDS["BEAST MODE"]={5:"MODO BESTIA"}
WORDS["INVINCIBILITY"]={5:"INVENCIBILIDAD"}
WORDS["NATIVE HUNTER"]={5:"CAZADOR NATIVO"}
WORDS["RUNE TOTEM"]={5:"TÓTEM DE RUNA"}
WORDS["SQUIRE"]={5:"ESCUDERO"}
WORDS["CASLE DEFENDER"]={5:"DEFENSOR DEL CASTILLO"}
